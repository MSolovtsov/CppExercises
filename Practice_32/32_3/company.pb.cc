...
PROTOBUF_CONSTEXPR Company::Company(::_pbi::ConstantInitialized)
    : _impl_{
      ...
      /*decltype(_impl_.qualification_)*/ {
          &::_pbi::fixed_address_empty_string,
          ::_pbi::ConstantInitialized{},
      },
      /*decltype(_impl_.year_of_foundation_)*/ 0,
      /*decltype(_impl_.economic_activity_)*/ false,
    } {}
...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.qualification_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.economic_activity_),
    3,
    0,
    1,
    2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "\004name\030\003 \002(\t\022\025\n\rqualification\030\004 \001(\t\022\031\n\021ec"
    "onomic_activity\030\005 \001(\010"
};
...
class Company::_Internal {
 public:
  ...
  static void set_has_qualification(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
...
Company::Company(const Company& from) : ::google::protobuf::Message() {
  ...
  new (&_impl_) Impl_{
      ...
      decltype(_impl_.economic_activity_){},
  };
  ...
  _impl_.qualification_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        _impl_.qualification_.Set("", GetArenaForAllocation());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if ((from._impl_._has_bits_[0] & 0x00000004u) != 0) {
    _this->_impl_.qualification_.Set(from._internal_qualification(), _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.year_of_foundation_, &from._impl_.year_of_foundation_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.economic_activity_) -
    reinterpret_cast<char*>(&_impl_.year_of_foundation_)) + sizeof(_impl_.economic_activity_));
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _impl_.qualification_.ClearNonDefaultToEmpty();
    }
  }
...
const ::_pbi::TcParseTable<3, 5, 0, 46, 2> Company::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Company, _impl_.year_of_foundation_), 3>(),
     {8, 3, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.year_of_foundation_)}},
    ...
    {::_pbi::TcParser::FastSS1,
     {34, 2, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.qualification_)}},
    // optional bool economic_activity = 5;
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Company, _impl_.economic_activity_), 4>(),
     {40, 4, 0, PROTOBUF_FIELD_OFFSET(Company, _impl_.economic_activity_)}},
    {::_pbi::TcParser::MiniParse, {}},
    {::_pbi::TcParser::MiniParse, {}},
  }}, {{
    65535, 65535
    ...
    // required int32 year_of_foundation = 1;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.year_of_foundation_), _Internal::kHasBitsOffset + 3, 0,
    ...
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional string qualification = 4;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.qualification_), _Internal::kHasBitsOffset + 2, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kRawString | ::_fl::kRepAString)},
    // optional bool economic_activity = 5;
    {PROTOBUF_FIELD_OFFSET(Company, _impl_.economic_activity_), _Internal::kHasBitsOffset + 4, 0,
...
::uint8_t* Company::_InternalSerialize(
  ...
  // optional string qualification = 4;
  if (cached_has_bits & 0x00000004u) {
    const std::string& _s = this->_internal_qualification();
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(_s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormat::SERIALIZE,
...
void Company::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_set_qualification(from._internal_qualification());
    }
    if (cached_has_bits & 0x00000008u) {
...
void Company::InternalSwap(Company* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.qualification_, lhs_arena,
                                       &other->_impl_.qualification_, rhs_arena);
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.economic_activity_)
      + sizeof(Company::_impl_.economic_activity_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.year_of_foundation_)>(
